...
surfaces.append(ReflectionSurface(sides_surfaces, 0.95))
...
render_scene(f"kaleidoscope_distance_{round(top_z - bottom_z, 1)}.png", surfaces, camera, 999, 999, 1)
