...
from models.primitives import get_sphere_equations, get_cylinder_equation, get_paraboloid_equation
...
surfaces.append(SolidSurface([
    *get_paraboloid_equation(0, 53.13, False, cone_pose, cone_rotation, [x-cone_pose[0], -x + (cone_pose[0] - cone_length)]),
